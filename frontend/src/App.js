...
function App() {
  ...
  if (loading) {
    return <div className="flex items-center justify-center min-h-screen bg-[#0a1929] dark:bg-[#0a1929]">Loading...</div>;
  }
    ...
    <ThemeProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/tasks" element={user ? <Tasks user={user} onLogout={handleLogout} /> : <Navigate to="/" />} />
